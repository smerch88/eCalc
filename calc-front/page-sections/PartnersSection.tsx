    ...
    <section>
      <div className="container py-10">
        ...
        <p className="text-2xl mb-12">
          Пропонуємо прилади від наших партнерів на основі ваших результатів,
          які будуть вигідними у вашому випадку. Ви можете підставити прилад з
          запропонованих до розрахунків натиснувши на “Розрахувати” та
          перевірити чи вигідно це для вас. Натиснувши “До магазину” ви
          перейдете на сайт партнера для замовлення приладу додому.
        </p>
